package com.bignerdranch.android.libwan;
...
public class CircleImageWan extends android.support.v7.widget.AppCompatImageView {
    ...
    public CircleImageWan(Context context) {
        super(context);
    }
    ...
    public CircleImageWan(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mChangeSize=typedArray.getBoolean(R.styleable.CircleImageWan_changeSize,true);
        }finally {
            typedArray.recycle();
        }
        init();
